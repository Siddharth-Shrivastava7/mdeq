...
class Dark_Zurich_Enhanced(BaseDataset):
    def __init__(self, 
                 root, 
                 list_path, 
                 num_samples=None, 
        ...
        super(Dark_Zurich_Enhanced, self).__init__(ignore_label, base_size,
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        image = cv2.imread(os.path.join(self.root,'dark_zurich_enhanced',item["img"]),
                           cv2.IMREAD_COLOR)
        size = image.shape
        ...
        label = cv2.imread(os.path.join(self.root,'dark_zurich_enhanced',item["label"]),
