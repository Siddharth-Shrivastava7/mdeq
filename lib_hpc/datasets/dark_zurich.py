...
class Dark_Zurich(BaseDataset):
    def __init__(self, 
        ...
        super(Dark_Zurich, self).__init__(ignore_label, base_size,
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        image = cv2.imread(os.path.join(self.root,'dark_zurich',item["img"]),
                           cv2.IMREAD_COLOR)
        size = image.shape
        ...
        label = cv2.imread(os.path.join(self.root,'dark_zurich',item["label"]),
